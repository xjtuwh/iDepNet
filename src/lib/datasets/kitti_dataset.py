...
class KittiDataset(data.Dataset):
    def __init__(self, root_dir, split='train'):
        ...
        # self.depth_dir = '/media/zd/1T/jcf/ip_basic-master/demos/depth_val'
        # self.depth_dir = '/media/zd/1T/jcf/dorn/depth_maps_trainval'
        # self.depth_dir = '/media/zd/2T/jcf/Pseudo_Lidar_V2-master/results/sdn_kitti_train_set/depth_maps/trainval'
        self.depth_dir = '/media/zd/2T/jcf/psmnet2_test/kitti/depth_map'
